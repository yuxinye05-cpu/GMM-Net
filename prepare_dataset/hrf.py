...
if __name__ == "__main__":
    ...
    #train
    img_train = "Datasets/HRF/training/images/"                # 定义相对路径
    gt_train = "Datasets/HRF/training/1st_manual/"
    fov_train = "Datasets/HRF/training/mask/"
    img_test = "Datasets/HRF/test/images/"
    gt_test = "Datasets/HRF/test/1st_manual/"
    fov_test = "Datasets/HRF/test/mask/"
    #---------------save path-----------------------------------------
    save_path = "data_path_list/HRF/"

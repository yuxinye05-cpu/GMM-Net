...
if __name__ == "__main__":
    ...
    #train
    img_train = "Datasets/DRIVE/training/images/"
    gt_train = "Datasets/DRIVE/training/1st_manual/"
    fov_train = "Datasets/DRIVE/training/mask/"
    #test
    img_test = "Datasets/DRIVE/test/images/"
    gt_test = "Datasets/DRIVE/test/1st_manual/"
    fov_test = "Datasets/DRIVE/test/mask/"
    #----------------------------------------------------------

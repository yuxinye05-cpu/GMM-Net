...
def get_path_list(img_path,label_path,fov_path):
    ...
    for i in range(len(tmp_list)):
        data_path = join('..',tmp_list[i])
        filename_list = os.listdir(data_path)
        filename_list.sort()
        res.append([join(tmp_list[i],j) for j in filename_list])
    return res
...
if __name__ == "__main__":
    ...
    #train
    img_train = "Datasets/STARE/training/images/"
    gt_train = "Datasets/STARE/training/1st_manual/"
    fov_train = "Datasets/STARE/training/mask/"
    #test
    img_test = "Datasets/STARE/test/images/"
    gt_test = "Datasets/STARE/test/1st_manual/"
    fov_test = "Datasets/STARE/test/mask/"
    #----------------------------------------------------------
